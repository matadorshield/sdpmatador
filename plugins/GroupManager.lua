--Begin GroupManager.lua By @ShieldTeams
...
if not lang then
 return "》*#lø¢κ* _ρøšт łš αlяeαđч lø¢κeđ_🔒\n*〰〰〰〰〰〰〰〰*\n*øяđeявч*: [@"..(check_markdown(msg.from.username or NoUseRNaMe)).."]"
elseif lang then
 return "》ارسال #لینک در گروه  از قبلا ممنوع است🔒\n*〰〰〰〰〰〰〰〰*\nسفارش توسط : [@"..(check_markdown(msg.from.username or NoUseRNaMe)).."]"
end
else
...
if not lang then
text = [[
̶K̶α̶I̶S̶E̶̶R̶ ̶M̶υ̶т̶є̶т̶ι̶м̶є̶ ̶Ƈ̶σ̶м̶м̶α̶η̶ɗ̶ѕ:
